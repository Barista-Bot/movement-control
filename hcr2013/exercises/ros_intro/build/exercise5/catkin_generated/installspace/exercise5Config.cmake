...
if("FALSE" STREQUAL "TRUE")
  set(exercise5_SOURCE_PREFIX /home/human/hcr2013/exercises/ros_intro/src/exercise5)
  set(exercise5_DEVEL_PREFIX /home/human/hcr2013/exercises/ros_intro/devel)
  ...
  set(exercise5_INSTALL_PREFIX /home/human/hcr2013/exercises/ros_intro/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'exercise5' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'the0s <the0s@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'exercise5' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/human/hcr2013/exercises/ros_intro/install/${idir}'.  Ask the maintainer 'the0s <the0s@todo.todo>' to fix it.")
    endif()
...
set(exercise5_EXPORTED_TARGETS "exercise5_generate_messages_cpp;exercise5_generate_messages_lisp;exercise5_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${exercise5_dep}_FOUND)
      find_package(${exercise5_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${exercise5_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(exercise5_INCLUDE_DIRS ${${exercise5_dep}_INCLUDE_DIRS})
  list(APPEND exercise5_LIBRARIES ${${exercise5_dep}_LIBRARIES})
...
if(exercise5_LIBRARIES)
  _remove_duplicate_libraries(exercise5_LIBRARIES exercise5_LIBRARIES)
endif()
