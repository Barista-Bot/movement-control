...
(cl:defmethod cl:initialize-instance :after ((m <JoyAxis>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JoyAxis)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exercise7-msg:<JoyAxis> is deprecated: use exercise7-msg:JoyAxis instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <JoyAxis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise7-msg:x-val is deprecated.  Use exercise7-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <JoyAxis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise7-msg:y-val is deprecated.  Use exercise7-msg:y instead.")
  (y m))
